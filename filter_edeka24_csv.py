...
# coding=utf-8
import csv
completecontent = csv.DictReader(open('edeka24_raw.csv','rb'))
g=open('edeka24_wein.csv', 'wb') #vielleicht mag auch rb besser passen
...
for inputrow in completecontent:
	...
	if "wein" in inputrow['MerchantProductCategory'].lower():
		...
		outputrow['author']='edeka24'
		outputrow['outlet']='Edeka Online Shop'
