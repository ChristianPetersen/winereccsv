...
# coding=utf-8
import csv
completecontent = csv.DictReader(open('gustini_raw.csv','rb'))
g=open('gustini_wein.csv', 'wb') #vielleicht mag auch rb besser passen
...
for inputrow in completecontent:
	...
	if "wein" in inputrow['MerchantProductCategory'].lower():
		...
		outputrow['author']='gustini'
		outputrow['outlet']='Gustini Online Shop'
