...
# coding=utf-8
import csv
completecontent = csv.DictReader(open('moevenpick_raw.csv','rb'))
g=open('moevenpick_wein.csv', 'wb') #vielleicht mag auch rb besser passen
...
for inputrow in completecontent:
	...
	if "wein" in inputrow['MerchantProductCategory'].lower():
		...
		outputrow['author']='moevenpick'
		outputrow['outlet']='moevenpick Online Shop'
